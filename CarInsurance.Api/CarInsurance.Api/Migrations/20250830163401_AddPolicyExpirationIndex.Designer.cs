...
namespace CarInsurance.Api.Migrations
{
    ...
    [Migration("20250830163401_AddPolicyExpirationIndex")]
    partial class AddPolicyExpirationIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarInsurance.Api.Models.InsurancePolicy", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpirationLoggedAtUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ExpirationLoggedAtUtc", "EndDate");
